...
main() {
  ...
  curl https://raw.githubusercontent.com/GloomyMeng/IM-Git-Hooks/master/simple-commit-msg.sh -o .git/hooks/commit-msg

  chmod +x .git/hooks/commit-msg

  _green "simple-commit-msg hook Install Success!"
}
